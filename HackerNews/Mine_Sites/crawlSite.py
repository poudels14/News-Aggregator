...
site[0] = "http://www.bloomberg.com/news/2014-10-09/five-reasons-why-icahn-says-apple-is-worth-1-2-trillion.html"
...
for x in site:
	...
	parser.feed(data)
        ...
        if len(ogTitle) > 0:
            ...
            print "twitterTitle = " + twitterTitle
        elif len(title) > 0:
            print "title = " + title
    #####################################################################
        if len(ogDescri)>0:
            print "ogDescri = " + ogDescri
        elif len(twitterDescri) > 0:
            print "twitterDescri = " + twitterDescri
        elif len(descri) > 0:
            print "descri = " + descri
    ...
    #####################################################################
        if len(ogImage)>0:
            ...
            print "twitterImage = " + twitterImage
        elif len(ogThumbnail) > 0:
            print "ogThumbnail = " + ogThumbnail
