...
site = {}
site[0] = "http://9to5mac.com/2014/10/31/stitcher-radio-podcast-app-updated-with-carplay-support-and-bug-fixes/"
...
def mine_single_site(site):
    ...
    if mineMeta:
        try:
            if (len(json["title"]) < 2) or json["descri"] == "Visit the post for more.":
                return;
